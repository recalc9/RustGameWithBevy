...
fn setup(mut commands: Commands,asset_server:Res<AssetServer>){
    ...
    commands.spawn(TextBundle::from_section(
        "Hold 'Left' or 'Right' to change the line width", TextStyle { 
            font: asset_server.load("D:\\Code\\Rust\\gizmos\\fonts\\FiraMono-Medium.ttf"), 
            font_size: 24., 
            color: Color::WHITE,
         },
        ));
...
fn system(mut gizmos: Gizmos,time: Res<Time>){
    ...
    gizmos.circle_2d(Vec2::ZERO, 120., Color::RED);
    ...
    gizmos.arc_2d(Vec2::ZERO, sin/10., PI/2.
        , 350., Color::ORANGE_RED);
}
